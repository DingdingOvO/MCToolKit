...
const strings: Record<LangCode, UIStrings> = {
  zh_cn: {
    ...
    heroTitle: 'MCToolKit',
    heroSubtitle: 'Minecraft 资源工具集 — 贴图 · 音效 · 数据',
    itemTextures: '物品贴图',
    blockTextures: '方块贴图',
    soundResources: '音效资源',
    itemDesc: '浏览 1222 种物品的贴图，支持 7 种语言搜索与下载',
  ...
  en_us: {
    ...
    itemCount: '{count} / {total}',
    heroTitle: 'MCToolKit',
    heroSubtitle: 'Minecraft Resource Toolkit — Textures · Sounds · Data',
    itemTextures: 'Item Textures',
    blockTextures: 'Block Textures',
    soundResources: 'Sound Resources',
    itemDesc: 'Browse 1222 item textures with multilingual search and download',
    blockDesc: 'Browse all block textures, covering 1269 block resources',
    soundDesc: '4871 game sound files, preview and download',
  ...
  zh_tw: {
    ...
    itemCount: '{count} / {total}',
    heroTitle: 'MCToolKit',
    heroSubtitle: 'Minecraft 資源工具集 — 貼圖 · 音效 · 資料',
    itemTextures: '物品貼圖',
    blockTextures: '方塊貼圖',
    soundResources: '音效資源',
    itemDesc: '瀏覽 1222 種物品的貼圖，支援 7 種語言搜尋與下載',
    blockDesc: '瀏覽全部方塊紋理，涵蓋 1269 種方塊資源',
    soundDesc: '4871 個遊戲音效檔案，線上試聽與下載',
    comingSoon: '即將上線',
  ...
  ja_jp: {
    ...
    itemCount: '{count} / {total}',
    heroTitle: 'MCToolKit',
    heroSubtitle: 'Minecraft リソースツールキット — テクスチャ · サウンド · データ',
    itemTextures: 'アイテムテクスチャ',
    blockTextures: 'ブロックテクスチャ',
    soundResources: 'サウンドリソース',
    itemDesc: '1222種のアイテムテクスチャを7言語で検索・ダウンロード',
    blockDesc: '1269種のブロックテクスチャを閲覧',
    soundDesc: '4871のゲームサウンドファイル、試聴・ダウンロード',
    comingSoon: '近日公開',
    footer: 'Minecraft 26.2 · データ来源 Mojang Public API',
  },
  ko_kr: {
    siteName: 'MCToolKit',
    home: '홈',
    ...
    itemCount: '{count} / {total}',
    heroTitle: 'MCToolKit',
    heroSubtitle: 'Minecraft 리소스 툴킷 — 텍스처 · 사운드 · 데이터',
    itemTextures: '아이템 텍스처',
    blockTextures: '블록 텍스처',
    soundResources: '사운드 리소스',
    itemDesc: '1222종 아이템 텍스처, 7개국어 검색 및 다운로드',
    blockDesc: '1269종 블록 텍스처 탐색',
    soundDesc: '4871개 게임 사운드 파일, 미리듣기 및 다운로드',
    comingSoon: '출시 예정',
    footer: 'Minecraft 26.2 · 데이터 출처 Mojang Public API',
  },
  de_de: {
    siteName: 'MCToolKit',
    home: 'Start',
    ...
    itemCount: '{count} / {total}',
    heroTitle: 'MCToolKit',
    heroSubtitle: 'Minecraft Ressourcen-Toolkit — Texturen · Sounds · Daten',
    itemTextures: 'Gegenstand-Texturen',
    blockTextures: 'Block-Texturen',
    soundResources: 'Sound-Ressourcen',
    itemDesc: '1222 Gegenstand-Texturen durchsuchen, 7 Sprachen, Download',
    blockDesc: '1269 Block-Texturen durchsuchen',
    soundDesc: '4871 Game-Sound-Dateien, anhören und herunterladen',
    comingSoon: 'Demnächst',
    footer: 'Minecraft 26.2 · Daten von Mojang Public API',
  },
  fr_fr: {
    siteName: 'MCToolKit',
    home: 'Accueil',
    ...
    itemCount: '{count} / {total}',
    heroTitle: 'MCToolKit',
    heroSubtitle: 'Boîte à outils Minecraft — Textures · Sons · Données',
    itemTextures: 'Textures d\'objets',
    blockTextures: 'Textures de blocs',
    soundResources: 'Ressources sonores',
    itemDesc: 'Parcourir 1222 textures d\'objets, recherche en 7 langues',
    blockDesc: 'Parcourir 1269 textures de blocs',
    soundDesc: '4871 fichiers sonores, écoute et téléchargement',
    comingSoon: 'Bientôt',
    footer: 'Minecraft 26.2 · Données de Mojang Public API',
  },
}
